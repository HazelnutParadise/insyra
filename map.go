...
// The mapFunc should take an element of any type and return a transformed value of any type.
func (dl *DataList) Map(mapFunc func(any) any) *DataList {
	defer func() {
		dl.mu.Unlock()
	}()
	dl.mu.Lock()
