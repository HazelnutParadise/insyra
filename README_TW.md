...
| **[quant](/Docs/quant.md)** | 量化金融策略／回測評估：夏普比率、VaR／CVaR、Sortino／Calmar 比率、最大回撤、年化報酬、市場 Beta／CAPM、多因子歸因、過擬合機率（CSCV PBO）、通縮夏普比率、walk-forward 驗證、block bootstrap 路徑模擬與百分位帶。 |
