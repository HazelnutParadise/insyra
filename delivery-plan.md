...
- Adding a dependency to the core module breaks the `accel/backend/wgpu` build until that module is re-tidied. `go mod tidy -C accel/backend/wgpu` is part of any core dependency change, and CI needs to build both modules.
