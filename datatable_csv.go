...
// ToCSVWithOptions writes the DataTable as CSV using opts. Like ToCSV, every
// write error is returned, including the one the CSV writer only reports when
// it flushes its buffer at the end.
