# datatable-ccl-failure-shape Specification

## Purpose
The four CCL methods on `DataTable` return the receiver, never nil, after a recovered panic, so a chained call cannot nil-dereference.
