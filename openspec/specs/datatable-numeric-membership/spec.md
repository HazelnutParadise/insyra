...
## Purpose
What counts as a number for `DropColsContainNumber` and `DropRowsContainNumber` (the built-in integer and float types, as `ClearNumbers` counts them), and for the denominator of `DataTable.Mean`.
