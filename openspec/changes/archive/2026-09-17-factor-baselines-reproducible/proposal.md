...
Backported. The R script and the reproducibility test apply unchanged: `crosslang_baseline.R` on this line was identical to `0.4`'s before this change. The failing-leaf counts in `stats/factor_analysis_test.go` are `0.4`'s and were not copied; this line's own count is re-measured separately.
